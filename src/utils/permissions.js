...
export class PermissionManager {
  ...
  getPermissionLabels(permissions) {
    const labels = {
      ...
      [PERMISSIONS.CLIENTS_DELETE]: "Excluir Clientes",
  ...
  getPermissionDescription(permission) {
    const descriptions = {
      ...
      [PERMISSIONS.CLIENTS_CREATE]: "Permite registar novos clientes",
      [PERMISSIONS.CLIENTS_EDIT]: "Permite modificar clientes existentes",
      [PERMISSIONS.CLIENTS_DELETE]: "Permite excluir clientes",
      [PERMISSIONS.CLIENTS_VIEW]: "Permite visualizar clientes",
